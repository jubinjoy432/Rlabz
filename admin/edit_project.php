...
<body>
    <nav class="navbar">
        <h1><i class="fa-solid fa-shield-halved"></i> RLabz Admin - Edit Project</h1>
        <div class="navbar-actions">
            <a href="dashboard.php" class="btn-view-site"><i class="fa-solid fa-arrow-left"></i> Back to Dashboard</a>
        </div>
    </nav>
    <div class="dashboard-container" style="grid-template-columns: 1fr; max-width: 800px;">
        <div class="card">
            <h2><i class="fa-solid fa-pen-to-square"></i> Edit Project: <?= htmlspecialchars($project['title']) ?></h2>
